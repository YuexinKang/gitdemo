...
public class GetImageByNet extends Object implements Runnable{
    ...
    public void run(){
        try {
            //new一个URL对象
            URL url = new URL("https://upload-images.jianshu.io/upload_images/16050459-2156a202ca9e8ba5.jpeg?imageMogr2/auto-orient/strip%7CimageView2/2/w/900/format/webp");
            //打开链接
